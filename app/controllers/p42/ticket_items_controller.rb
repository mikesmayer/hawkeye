class P42::TicketItemsController < ApplicationController
  ...
  private
    ...
    def p42_ticket_item_params
      params.require(:p42_ticket_item).permit(:auto_discount, :gross_price, :item_qty, :manual_discount, :menu_itme_group_id, :menu_item_id, :net_price, :pos_ticket_id, :pos_ticket_item_id, :revenue_group_id, :ticket_id, :meal_for_meal)
    end
end
